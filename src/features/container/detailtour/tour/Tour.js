    ...
    return (
        <div id="detail-tour">
                            ...
                            <div className="row justify-content-center" >
                                <div className="col-lg-8">
                                    <div className="tour-header">
                                        <Carousel autoplay>
                                            <div>
                                                <img src={tours.find(x => x.id === +id)?.avatar} alt="avatar" />
                                            </div>
                                        </Carousel>
                                        <h3>{ok.name}</h3>
                                    </div>
                                            ...
                                            <table className="w-100">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span>{ok.noikhoihang}</span></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
            ...
            >
                ...
                {tour_ngay.map(ok => (
                    <p key={ok.id}>
                        Số tiền cần phải trả: <strong className="text-danger">
            ...
            >
                ...
                <Hinhthucthanhtoan callback={value => setPaymentMethod(value)} />
                ...
                <input
                    type="checkbox"
                    onChange={e => setState({ ...state, dieukhoan: e.target.checked })}
